...
const OrderDetailPage = () => {
  ...
  const handlePreview = (doc: typeof order.documents[0]) => {
    window.open(`${API_BASE_URL}/documents/${doc.document_id}/preview`, '_blank');
  };

  const helperText = orderStatusHelperText[order.order_status as OrderStatus] || '';
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <h1 className="font-heading text-xl text-wizard-text">Order #{order.order_id}</h1>
            ...
            <div className="space-y-0">
              <div className="flex justify-between py-3 border-b border-wizard-border">
                ...
                <span className="text-wizard-text font-medium">{order.plan_name}</span>
              </div>
              <div className="flex justify-between py-3 border-b border-wizard-border">
              ...
              {naicsCodes.length > 0 && (
                <div className="flex justify-between py-3 border-b border-wizard-border">
                  <span className="text-wizard-text-muted text-sm">NAICS Codes</span>
                    ...
                    {showNaicsExpand && (
                      ...
                      >
                        {naicsExpanded ? (
                          ...
                          <>
                            +{naicsCodes.length - 2} more <ChevronDown className="w-3 h-3" />
                          </>
                        )}
                      </button>
                    )}
            ...
            <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-wizard-border">
              ...
              <Button variant="outline" size="sm" asChild>
                <a href={`mailto:support@ohsremote.com?subject=Order%20${order.order_id}`}>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl border border-wizard-border shadow-lg shadow-black/5 p-8"
          >
            <h2 className="font-heading text-xl text-wizard-text mb-6">Documents</h2>
        ...
        <div className="lg:col-span-1">
          ...
          >
            <h3 className="font-heading text-lg text-wizard-text mb-6">Order Progress</h3>
