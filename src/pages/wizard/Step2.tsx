    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div>
          ...
          />
          {companyNameError && (
            <p className="text-error text-sm mt-1">{companyNameError}</p>
          )}
        </div>
      </motion.div>
      ...
      >
        <h3 className="font-heading text-xl text-wizard-text mb-2">
          Company Logo {logoOptional ? "(Optional)" : "(Required)"}
        </h3>

        <p className="text-wizard-text-muted text-sm mb-6">
          {isSjpOnlySelected
            ? "Logo upload is optional for the SJP Only package."
            : "Upload your company logo to brand your deliverable."}
        </p>
